...
var ScrollerComponent = (function () {
    ...
    ScrollerComponent.prototype.ngAfterContentInit = function () {
        ...
        var scrollerViewHeight = this.scrollerViewEl.offsetHeight;
        ...
        setTimeout(function () {
            _this.shouldNavBeVisible();
            _this.checkButtonStates();
        });
        this.renderer.listenGlobal('window', 'resize', this.debounce(this.shouldNavBeVisible, 100, this));
        this.renderer.listen(this.scrollerViewEl, 'scroll', this.debounce(this.checkButtonStates, 0, this));
        this.renderer.listenGlobal('window', 'resize', this.debounce(this.checkButtonStates, 100, this));
    };
